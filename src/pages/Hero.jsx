  ...
  return (
    ...
    <div id='hero'>
        <div className='mt-[50px] md:mt-[80px] flex bg-[#242526] w-[100%] h-[500px] md:h-[650px]'>
            <div className='w-[85%] h-[100%] m-auto mt-[50px] md:mt-[150px] flex'>
                <div>
                    <h1 className='w-[200px] md:w-[440px] h-[100px] md:h-[150px] text-white text-xl md:text-4xl lg:5xl font-bold'>
                    ...
                    <button className='bg-[#FF5300] rounded mt-4 md:mt-6 p-2 md:p-3 text-white shadow-lg'><a href='#'>Contact Us</a></button>
                </div>
                <div>
                    <img src='' alt='/' />
                </div>
